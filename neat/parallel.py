...
class ParallelEvaluator(object):
    ...
    def evaluate(self, genomes, config, namespace, game_queue, vision_queue):
        jobs = []
        for ignored_genome_id, genome in genomes:
            jobs.append(self.pool.apply_async(self.eval_function, (genome, config, namespace, game_queue, vision_queue)))
